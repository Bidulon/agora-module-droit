...
<table style="width:100%;height:300px;border-spacing:8px;"><tr>
	<td style="max-width:200px;vertical-align:middle;">
		<img src="<?php echo ($contact_tmp["photo"]=="") ? PATH_TPL."divers/inconnu.png" : PATH_MOD_CONTACT.$contact_tmp["photo"]; ?>" alt="photo" />
	</td>
...
<?php
		...
		if($contact_tmp["commentaire"]!="")			echo "<tr><td class=\"lib_user\"><img src=\"".PATH_TPL."module_utilisateurs/user_commentaire.png\" /> ".$trad["commentaire"]." </td><td>".$contact_tmp["commentaire"]."</td></tr>";
		////	CARTE MASHUP
