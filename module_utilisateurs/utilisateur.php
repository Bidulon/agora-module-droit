...
<table style="width:100%;height:280px;border-spacing:8px;"><tr>
	<td style="max-width:200px;text-align:center;vertical-align:middle;">
		<img src="<?php echo ($user_tmp["photo"]=="") ? PATH_TPL."divers/inconnu.png" : PATH_MOD_USER.$user_tmp["photo"]; ?>" />
	</td>
...
<?php
			...
			if($user_tmp["commentaire"]!="")		echo "<tr><td class=\"lib_user\"><img src=\"".PATH_TPL."module_utilisateurs/user_commentaire.png\" /> ".$trad["commentaire"]." </td><td>".$user_tmp["commentaire"]."</td></tr>";
			////	DERNIERE CONNEXION
