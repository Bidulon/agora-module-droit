...
titre_popup("<img src=\"".PATH_TPL."divers/utilisateurs_groupe.png\" />&nbsp; ".$lib_gestion_groupe."<div style=\"margin-top:5px;font-weight:normal;font-style:italic;\">".$trad["UTILISATEURS_droit_gestion_groupes"]."</div>");
?>
