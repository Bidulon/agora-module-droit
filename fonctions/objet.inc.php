...
////	TEXTE POUR LES AFFECTATIONS  (element_menu.inc.php)
////
...
function width_element($nb_elems_ligne)
{
	...
	return floor((@$_SESSION["cfg"]["resolution_width"] - LARGEUR_MENU_GAUCHE - (7 * $nb_elems_ligne) - 10) / $nb_elems_ligne)."px";
}


////	INITIALISATION DE LA TAILLE DES ELEMENTS  =>   $width_init  = "100%" / "large" / "medium" / "small"
////
function elements_width_height_type_affichage($width_init, $height_init_px, $type_affichage_defaut)
{
	////	INIT
	global $width_element, $height_element, $nb_elements_ligne;

	////	AFFICHAGE "BLOCK" ou "LISTE" ou "ARBORESCENCE" (forum)  =>  RECUP' LA PREFERENCE EN BDD, SINON AFFICHAGE PAR DEFAUT
	...
	////	AFFICHAGE "LISTE"
	if(@$_REQUEST["type_affichage"]=="liste")
	{
...
function div_element($obj_tmp, $id_objet)
{
	...
	// Style
	$style  = "width:".$width_element.";height:".$height_element.";cursor:url('".PATH_TPL."divers/elements_selectionner.png'),crosshair;";
