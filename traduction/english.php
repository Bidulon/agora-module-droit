...
$trad["users_importer"] = "Import users";
$trad["users_exporter"] = "Export users";
$trad["contact_importer"] = "Import contacts";
$trad["contact_exporter"] = "Export contacts of the folder";
$trad["contact_import_formats"] = ".csv format";
$trad["contact_export_formats"] = ".csv / LDIF format";
...
$trad["import_infos_user"] = "If the login and password are not selected, they will be generated automatically.<br>Also, check this informations";
$trad["import_alert"] = "Thank you for selecting the first name and last name's columns in the select boxes";
...
$trad["EDIT_OBJET_alert_ecriture_limite_defaut"] = "Warning! with write access, all messages can be deleted! \\n\\nIt is recommended to use limited write access";
...
$trad["EDIT_OBJET_admin_espace"] = "Administrator of this space: <br>write access to all the elements of this space";
...
$trad["ESPACES_modules_classement"] = "Classification of the modules";
...
$trad["ESPACES_invites_infos"] = "Provides access to people who do not have accounts on the site : guests. Ability to specify a password to protect access.";
...
$trad["ESPACES_invitation"] = "User +";
$trad["ESPACES_invitation_info"] = "User of the space + ability to send email invitations to add new users to the space";
...
$trad["UTILISATEURS_ajouter_adr_ip"] = "Add an control IP address";
$trad["UTILISATEURS_specifier_adr_ip"] = "You must specify an IP address";
...
$trad["UTILISATEURS_liste_adresses_ip"] = "list of control IP addresses";
$trad["UTILISATEURS_suppr_adresses_ip"] = "Delete the IP address";
...
$trad["AGENDA_afficher_tous_agendas"] = "Display all the calendars";
...
$trad["FICHIER_video_ogv"]  = "If this video doesn't play, use a web browser like <br/><a href=\"http://www.mozilla-europe.org/firefox/\">Mozilla Firefox</a> (3.5 or higher), <a href=\"http://www.google.com/chrome\">Google Chrome</a> or Chromium (3 or higher), or <a href=\"http://www.opera.com/\">Opera</a> (10.50 or higher)";
$trad["FICHIER_video_webm"] = "If this video doesn't play, use a web browser like <br/><a href=\"http://www.mozilla-europe.org/firefox/\">Mozilla Firefox</a> (4 or higher), <a href=\"http://www.google.com/chrome\">Google Chrome</a> or Chromium (6 or higher), or <a href=\"http://www.opera.com/\">Opera</a> (10.60 or higher)";
...
$trad["FORUM_pas_message"] = "No message for this topic";
...
$trad["TACHE_priorite_1"] = "Low";
$trad["TACHE_priorite_2"] = "Medium";
$trad["TACHE_priorite_3"] = "High";
$trad["TACHE_priorite_4"] = "Critical";
