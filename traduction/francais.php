...
$trad["users_importer"] = "Importer des utilisateurs";
$trad["users_exporter"] = "Exporter des utilisateurs";
$trad["contact_importer"] = "Importer des contacts";
$trad["contact_exporter"] = "Exporter les contacts du dossier";
$trad["contact_import_formats"] = "format .csv";
$trad["contact_export_formats"] = "format .csv / LDIF";
$trad["contact_format"] = "format";
...
$trad["import_infos_user"] = "Si L'identifiant et le mot de passe ne sont pas sélectionnés, ils seront générés automatiquement.<br>Pensez également à controler ces informations après l'import";
$trad["import_alert"] = "Merci de sélectionner les colonnes nom et prénom dans les listes déroulante";
...
$trad["inscription_users_option_espace"] = "Permettre aux visiteurs de s'incrire sur l'espace";
$trad["inscription_users_option_espace_info"] = "La création du compte utilisateur se fait sur la page d'accueil du site. Elle doit ensuite être validée par l'administrateur de l'espace.";
...
$trad["MSG_ALERTE_nom_fichier"] = "Un fichier avec le même nom existe déjà, mais il n'a pas été remplacé";
...
$trad["EDIT_OBJET_alert_ecriture_limite_defaut"] = "Attention ! avec un accès en ecriture, tous les messages peuvent être effacés ! \\n\\nIl est donc conseillé de mettre un accès en écriture limité";
...
$trad["EDIT_OBJET_admin_espace"] = "Administrateur de l'espace : <br>accède en écriture à tous les elements de l'espace";
...
$trad["PARAMETRAGE_libelle_module"] = "Nom des modules dans la barre principale";
...
$trad["ESPACES_modules_classement"] = "Classement des modules à l'affichage";
...
$trad["ESPACES_invites_infos"] = "Donne accès aux personnes qui n'ont pas de compte sur le site : ''invités''. Possibilité de spécifier un mot de passe pour protéger l'accès.";
...
$trad["ESPACES_invitation"] = "Utilisateur +";
$trad["ESPACES_invitation_info"] = "Accès normal à l'espace + possibilité d'envoyer des invitations par mail pour ajouter des utilisateurs à l'espace";
...
$trad["UTILISATEURS_ajout_utilisateurs_groupe"] = "Les utilisateurs peuvent également créer des groupes";
// Index.php
...
$trad["UTILISATEURS_envoi_coordonnees_infos"] = "Envoyer à des utilisateurs (par mail)<br/>leur identifiant et <u>un nouveau</u> mot de passe";
$trad["UTILISATEURS_envoi_coordonnees_confirm"] = "Attention : les mots de passe seront réinitialisés ! confirmer tout de même ?";
$trad["UTILISATEURS_mail_coordonnees"] = "Coordonnées de connexion";
...
$trad["UTILISATEURS_agenda_perso_active_infos"] = "S'il est activé, l'agenda personnel reste <u>toujours</u> accessible à l'utilisateur, même si le module Agenda de l'espace courant est désactivé.";
...
$trad["UTILISATEURS_ajouter_adr_ip"] = "Ajouter une adresse IP de contrôle";
$trad["UTILISATEURS_specifier_adr_ip"] = "Vous devez spécifier une adresse IP";
...
$trad["UTILISATEURS_liste_adresses_ip"] = "Adresses IP de contrôle";
$trad["UTILISATEURS_suppr_adresses_ip"] = "Supprimer l'adresse IP";
...
$trad["UTILISATEURS_visibilite_messenger_livecounter"] = "Utilisateurs qui me voient en ligne et peuvent discuter avec moi sur la messagerie instantanée";
...
$trad["FICHIER_video_ogv"]  = "Si cette vidéo ne s'affiche pas, utilisez un navigateur tel <br/><a href=\"http://www.mozilla-europe.org/firefox/\">Mozilla Firefox</a> (3.5 ou suivant), <a href=\"http://www.google.com/chrome\">Google Chrome</a> ou Chromium (3 ou suivant), ou <a href=\"http://www.opera.com/\">Opera</a> (10.50 ou suivant)";
$trad["FICHIER_video_webm"] = "Si cette vidéo ne s'affiche pas, utilisez un navigateur tel <br/><a href=\"http://www.mozilla-europe.org/firefox/\">Mozilla Firefox</a> (4 ou suivant), <a href=\"http://www.google.com/chrome\">Google Chrome</a> ou Chromium (6 ou suivant), ou <a href=\"http://www.opera.com/\">Opera</a> (10.60 ou suivant)";
...
$trad["FORUM_ajout_sujet_theme"] = "Les utilisateurs peuvent également ajouter des thèmes";
// TRI
...
$trad["FORUM_pas_message"] = "Pas de message pour ce sujet";
...
$trad["FORUM_infos_droits_acces"] = "Pour participer au sujet, il faut être au minimum en ''ecriture limité''";
...
$trad["TACHE_priorite_1"] = "Basse";
$trad["TACHE_priorite_2"] = "Moyenne";
$trad["TACHE_priorite_3"] = "Haute";
$trad["TACHE_priorite_4"] = "Critique";
...
$trad["MAIL_afficher_destinataires_message"] = "Ne pas masquer les destinataires";
$trad["MAIL_afficher_destinataires_message_infos"] = "Afficher les destinataires dans le message, pour pouvoir ''répondre à tous''";
