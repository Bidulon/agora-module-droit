...
.cell_jour_mois_pre_suiv{ background-color:#eee; border-width:2px 1px 1px 2px; border-color:#f5f5f5 #ddd #ddd #f5f5f5; border-style:solid; }
...
<table style="width:100%;" cellpadding="0px" cellspacing="0px">
	...
	foreach($jours_affiches as $jour_ymd)
	{
		...
		////	AFFICHAGE
		////
		// Debut de la ligne de semaine : numero de semaine
		if($jour_semaine==1)	echo "<tr><td class='num_semaine' onClick=\"redir('index.php?affichage_demande=semaine&date_affiche=".$T_debut."');\" title=\"".$trad["AGENDA_voir_num_semaine"]." ".strftime("%W",$T_debut)."\">".strftime("%W",$T_debut)."</td>";
		// Cellule du jour
