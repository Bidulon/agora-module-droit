...
.synth_lib_agenda			{ padding-left:5px; text-align:left; vertical-align:middle; font-size:13px; }
			...
			echo "<tr onClick='goToByScroll('div_agenda_".$id_agenda."');' class='synth_ligne_agenda'>";
				...
				{			
					...
					if(count($liste_evenements_tmp)>0)
					{
						...
						$tab_evts_jour = "<table class='synth_tab_evts_jour' cellspacing='0px'><tr>";
