...
elseif(@$cfg_menu_elem["taille_icone"]=="small")	$div_elem_style = "float:left;margin:0px;margin-top:-2px;margin-right:8px;";
...
echo "<div class='noprint' style='".$div_elem_style."'>";
	...
	echo "<div class='menu_context' id='".$id_menu_contextuel."' onMouseOver=\"afficher(this.id,true);\" onMouseOut=\"afficher(this.id,false);\">";
		...
		////	FICHIER : NOMBRE DE TELECHARGEMENTS
		if($cfg_menu_elem["objet"]["type_objet"]=="fichier")
			echo "<div class='menu_context_ligne'><div class='menu_context_img'><img src=\"".PATH_TPL."divers/telecharger.png\" /></div><div class='menu_context_txt'>".$trad["telecharge_nb"]."  ".$cfg_menu_elem["objet_infos"]["nb_downloads"]."  ".$trad["telecharge_nb_bis"]."</div></div><hr class='menu_context_hr' />";
	...
	////	ICONE "PLUS" & CLICK DROIT POUR AFFICHER LE MENU CONTEXTUEL
	////
	$icone_taille_tmp = (@$cfg_menu_elem["taille_icone"]=="")  ?  "style='height:23px;'"  :  "";
	...
	echo "<img src=\"".PATH_TPL."divers/".$icone_src_tmp.".png\" class='noprint' ".$icone_taille_tmp." id='icone_".$id_menu_contextuel."' onMouseOver=\"afficher_menu_contextuel('".$id_menu_contextuel."');\" onMouseOut=\"afficher('".$id_menu_contextuel."',false);\" />";
	...
	if($_SESSION["user"]["id_utilisateur"]>0 && $icone_element_individuel==true && $objet_independant==true && !isset($cfg_menu_elem["taille_icone"]))
		echo "<br /><img src=\"".PATH_TPL."divers/acces_utilisateur.png\" style='width:13px;' ".infobulle($trad["acces_perso"])." />";
