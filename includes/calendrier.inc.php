...
<div onMouseDown="return false;" style="margin:2px;text-align:center;">
	<table class="cal_tableau"  style="font-weight:bold;margin:5px;" cellpadding="0px" cellspacing="0px"><tr>
	...
	<table class="cal_tableau" style="font-size:11px;" cellpadding="0" cellspacing="0">
		<tr>
			<?php
			////	JOURS DE LA SEMAINE
