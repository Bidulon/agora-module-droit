...
function selection_element(cpt_div_element, select)
{
	...
	if(existe("menu_elements_edit")){
		if(nb_elements_select()>0 && element("menu_elements_edit").style.display=="none")	afficher_dynamic('menu_elements_edit', null, true);
		if(nb_elements_select()==0 && element("menu_elements_edit").style.display!="none")	afficher_dynamic('menu_elements_edit', null, false);
	}
...
function selection_tous_elements(select, type_element)
{
	...
	afficher_dynamic("menu_elements_edit", null, afficher_block);
}
