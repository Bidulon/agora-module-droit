...
echo "<table class='contenu_principal_centre'><tr>";
	...
	echo "<td>";
		foreach($liste_actualites as $actu_tmp)
		{
			...
			// Div conteneur
			echo "<div class='div_elem_deselect' id='actualite".$actu_tmp["id_actualite"]."' style='float:none;overflow:hidden;max-height:".$hauteur_maxi_actus."px;min-height:60px;margin-bottom:10px;".($actu_tmp["une"]==1?STYLE_SHADOW_SELECT:"")."'>";
				// "Tout afficher" ?
