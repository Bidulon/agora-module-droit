...
function controle_formulaire()
{
	...
	requete_ajax("GET", "dossier_edit_verif.php?nom="+get_value("nom")+"&id_dossier=<?php echo @$dossier_tmp["id_dossier"]; ?>&id_dossier_parent=<?php echo $dossier_tmp["id_dossier_parent"]; ?>&type_objet_dossier=<?php echo $_REQUEST["type_objet_dossier"]; ?>&module_dossier=<?php echo $_REQUEST["module_dossier"]; ?>");
