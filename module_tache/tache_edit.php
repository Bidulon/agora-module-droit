...
function affiche_priorite(valeur)
{
	...
	if(valeur=="")	valeur = "non";
	element("img_priorite").src = "<?php echo PATH_TPL; ?>module_tache/priorite_"+valeur+".png";
}
...
<form action="<?php echo php_self(); ?>" method="post" enctype="multipart/form-data" OnSubmit="return controle_formulaire();" style="padding:10px;font-weight:bold;">
	...
	echo "<fieldset style='text-align:center;'>";
		...
		echo "<span id='block_description'><br /><br /><textarea name='description' id='description' style='width:100%;height:180px;'>".@$tache_tmp["description"]."</textarea></span>";
		if(@$tache_tmp["description"]=="")	echo "<script type='text/javascript'>  masquer_block_description_onload();  </script>";
	echo "</fieldset>";
	...
	echo "<fieldset style='text-align:center;'>";
		...
		echo "&nbsp;<select name='priorite' id='priorite' onChange=\"affiche_priorite(this.value);\">";
			echo "<option value=''>&nbsp;</option>";
			echo "<option value='1'>".$trad["TACHE_priorite_1"]."</option>";
			echo "<option value='2'>".$trad["TACHE_priorite_2"]."</option>";
			echo "<option value='3'>".$trad["TACHE_priorite_3"]."</option>";
			echo "<option value='4'>".$trad["TACHE_priorite_4"]."</option>";
		echo "</select>";
		...
		echo "<span onclick=\"afficher('div_responsables');\" class='lien'><img src=\"".PATH_TPL."divers/utilisateurs_small.png\" /> ".$trad["TACHE_responsables"]." <img src=\"".PATH_TPL."divers/derouler.png\" /></span>";
